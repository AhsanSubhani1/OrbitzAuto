...
public class ExtentManager {
    ...
    public void reportEnvironment(GlobalVariables globalVariables2){
        if (count==0) {
            ...
            globalVariables2.extent.setSystemInfo("Browser Name:",caps.getBrowserName());
            globalVariables2.extent.setSystemInfo("Browser Version:",caps.getVersion());
            globalVariables2.extent.setSystemInfo("Operating System:",System.getProperty("os.name"));
            globalVariables2.extent.setSystemInfo("Environment: ",globalVariables2.environment);
            globalVariables2.extent.setSystemInfo("Platform: ",globalVariables2.platform);
    ...
    void flushReportingDirectory() {
        ...
        if (flushCount == 0) {
            ...
            try {
                ...
                globalVariables.commonFunc.logInfo(null, "Exception - Trying to clean directory, BaseController.Java|Starter");
            }
            flushCount++;
        }
    }
